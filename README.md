...
- **suzunia 本体はフリーウェアです。** 無償で利用できます。著作権は作者が保有しますがAIに全部作らせたのに著作権あんの不思議やね？
- 配布 zip をそのままの形で共有するのは自由です。改変しての再配布、実行ファイルの解析 (逆コンパイル・逆アセンブル) はやりたきゃ好きにして。一晩で作ったって言ってるでしょ？
